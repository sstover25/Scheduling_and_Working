...
// If the time block is in the past, it will be gray.
// If the time block is current, it will be red.
// If the time block is in the future, it will be green.
function timeCheck() {
...
// save the data in each row to local Storage. If the corresponding save button is pushed, then the text in that time block is saved to localStorage.
// 9 AM
...
// load saved data from local Storage. This checks to see if there is any saved data for the different time blocks. If they exist, they are then loaded to the appropriate text field.
